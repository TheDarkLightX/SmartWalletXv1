...
contract SmartAccountIntegration is Test {
    ...
    function testPluginLifecycleWithRealCalls() public {
        ...
        bytes memory code = hex"6080604052600080fdfea26469706673582212206bb5b42d17f3cb3a1716d8384652ec72ffac35daf1e891f7a1fae3bdfc0cb19964736f6c63430008110033";
    ...
    function testRevertOnExecutionFailure() public {
        ...
        bytes memory revertingCode = hex"6080604052600080fd00";
    ...
    function invariant_OwnerShouldNeverBeZeroAddress() public {
        assertTrue(account.owner() != address(0), "Owner should never be zero address");
    }
    
    function invariant_EntryPointShouldBeImmutable() public {
